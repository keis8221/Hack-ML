...
class Img2TxtCLIPReward():
    ...
    def get_img2txt(self):
        ...
        return imgname_lst, sents_lst

def get_csv():
    output = Img2TxtCLIPReward()
    imgname_lst, sents_lst = output.get_img2txt()
    df = pd.DataFrame({'img_name': imgname_lst, 'img2text': sents_lst})
    save_path = "/home/tomo/Documents/hack/Hack-ML/code/mlike/output"
    df.to_csv(save_path+'/img2txt.csv', index=False)
